...
.alert-success { background-color: #e8f5e9; color: #2e7d32; border-left: 4px solid #66bb6a; }
label {
    font-size: 0.85rem;
    font-weight: 600;
    color: #546e7a;
...
<div class="container py-5" style="max-width:480px;">
  <div class="card p-4">
    <h4><i class="bi bi-person-plus-fill me-2"></i>Register Admin</h4>
    
    <?php if($msg): ?>
        <div class="alert <?= strpos($msg, 'success') !== false ? 'alert-success' : 'alert-warning' ?>">
    ...
    <form method="post">
      ...
      <button class="btn btn-primary w-100">Register Admin</button>
      
      <a href="login.php" class="btn btn-outline-teal w-100">
